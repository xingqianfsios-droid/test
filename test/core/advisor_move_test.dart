...
void main() {
  group('仕/士 (Advisor) 走法测试', () {
    test('红仕在九宫中央可走4步', () {
      final pieces = [
        const PieceModel(id: 'p1', type: PieceType.advisor, side: PieceSide.red, col: 4, row: 8),
      ];
    ...
    test('红仕在角落只能走1步', () {
      final pieces = [
        const PieceModel(id: 'p1', type: PieceType.advisor, side: PieceSide.red, col: 3, row: 7),
      ];
      final board = buildBoard(pieces);
    ...
    test('黑士在九宫中央可走4步', () {
      final pieces = [
        const PieceModel(id: 'p1', type: PieceType.advisor, side: PieceSide.black, col: 4, row: 1),
      ];
      final board = buildBoard(pieces);
    ...
    test('仕不可走出九宫', () {
      final pieces = [
        const PieceModel(id: 'p1', type: PieceType.advisor, side: PieceSide.red, col: 5, row: 9),
      ];
      final board = buildBoard(pieces);
    ...
    test('仕不可吃己方棋子', () {
      final pieces = [
        const PieceModel(id: 'p1', type: PieceType.advisor, side: PieceSide.red, col: 4, row: 8),
        const PieceModel(id: 'p2', type: PieceType.king, side: PieceSide.red, col: 3, row: 7),
      ];
      final board = buildBoard(pieces);
      final moves = getAdvisorMoves(col: 4, row: 8, side: PieceSide.red, board: board);
    ...
    test('仕可吃敌方棋子', () {
      final pieces = [
        const PieceModel(id: 'p1', type: PieceType.advisor, side: PieceSide.red, col: 4, row: 8),
        const PieceModel(id: 'p2', type: PieceType.soldier, side: PieceSide.black, col: 3, row: 7),
      ];
      final board = buildBoard(pieces);
      final moves = getAdvisorMoves(col: 4, row: 8, side: PieceSide.red, board: board);
